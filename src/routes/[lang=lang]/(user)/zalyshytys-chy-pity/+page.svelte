<script lang="ts">
	...
	const sessions = [
		...
		{
			number: '02',
			title: 'Якою я стаю поруч із ним/нею?',
	...
	const faqs = [
		{
			...
			answer: 'Ні. Можна прийти саме тому, що ти не знаєш, чого хочеш.'
		},
		{
			question: 'А якщо під час групи я вирішу залишитися у стосунках?',
			answer: 'Це нормально. Мета групи не в тому, щоб привести учасниць до розставання.'
		},
		{
			question: 'А якщо я не прийму рішення за сім тижнів?',
			answer:
				'Це теж нормально. Мета не в тому, щоб змусити себе прийняти рішення до певної дати, а краще зрозуміти себе і те, що відбувається у стосунках.'
		},
		{ question: 'Чи будуть записи?', answer: 'Ні. Зустрічі не записуються.' },
		{
			question: 'Чи можна приєднатися після старту?',
			answer: 'Ні. Після першої зустрічі група закривається.'
		},
		{
			question: 'Чи потрібно спочатку приходити на індивідуальну консультацію?',
			answer:
				'Ні. Спочатку потрібно заповнити коротку анкету. Якщо перед підтвердженням участі потрібно буде щось уточнити, я сама запропоную коротку розмову.'
		}
	];
...
<section class="bg-background px-4 py-12 text-primary sm:px-6 sm:py-16">
	<div class="mx-auto max-w-4xl rounded-3xl bg-white p-7 shadow-sm sm:p-10">
		<h2 class="text-3xl leading-tight font-bold sm:text-4xl">
			Тут не буде готової відповіді, як тобі вчинити
		</h2>
		<div class="mt-6 space-y-4 text-lg leading-relaxed text-primary/80">
			<p>Я не буду переконувати тебе розлучатися або, навпаки, зберігати стосунки.</p>
			<p>
				За ці сім тижнів ми будемо більше дивитися не на питання «який він/вона?», а на «що
